...
function gotStream(localStream) {
  ...
  console.log('Received local stream from audio device');
...
function call(calledParty) {
  let elementId = document.getElementById("status" + calledParty)
  elementId.disabled = true;
  console.log('Starting call to ' + calledParty);
